class Layout {
    ...
    layout1(){
        ...
        this.wall4 = createSprite(300, 1210, 700, 20);
        this.wall5 = createSprite(1590, 1210, 700, 20);
        this.wall6 = createSprite(630, 1450, 20, 500);
        this.wall7 = createSprite(1260, 1450, 20, 500);

        this.wall8 = createSprite(300, 1700, 620, 20);
        this.wall9 = createSprite(1600, 1700, 620, 20);
        this.wall10 = createSprite(1900, 2900, 20, 2400);
        this.wall11 = createSprite(0, 2900, 20, 2400);

        this.wall12 = createSprite(625, 2240, 1250, 20);
        this.wall13 = createSprite(625, 2640, 1250, 20);

        this.wall14 = createSprite(1260, 2450, 20, 430);

        this.wall15 = createSprite(1260, 3170, 1270, 20);

        this.wall16 = createSprite(1260, 3440, 1270, 20);

        this.wall17 = createSprite(630, 3300, 20, 300);

        this.wall18 = createSprite(1590, 4110, 620, 20);

        this.wall19 = createSprite(300, 4110, 620, 20);

        this.wall20 = createSprite(1280, 4420, 20, 600);
        this.wall21 = createSprite(620, 4420, 20, 600);
        ...
        this.wall48 = createSprite(970, 7390-10, 2000, 20);
